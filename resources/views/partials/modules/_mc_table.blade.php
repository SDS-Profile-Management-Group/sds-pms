<div id="mc-div" class="bg-white shadow-md rounded-lg p-6 mb-6 module-div" data-update-url="{{ route('modules.update', ':module_id') }}">
    <span>
    ...
    <table class="min-w-full table-auto border-collapse border border-gray-300">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="4" class="py-2 px-4 border text-center">No Major Core modules found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
